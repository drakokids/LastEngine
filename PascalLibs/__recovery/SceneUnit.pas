...
type
  ...
  private
    ...
    FParticles: array of TGameParticles; //Various groups of particles
  public
    ...
    function AddParticle(ParticleType:LEparticleType; particleWidth, particleHeight: integer): integer;
    function Particle(index: integer): TGameParticles;
...
function TGameScene.AddParticle(ParticleType:LEparticleType;  particleWidth, particleHeight: integer): integer;
var index: integer;
begin
   index:=Length(FParticles);
   SetLength(FParticles,index+1);
   FParticles[index]:=TGameParticles.Create(particleWidth,particleHeight);
   FParticles[index].Index:=index;
   FParticles[index].particleType:=ParticleType;

   result:=index;

end;

function TGameScene.Particle(index: integer): TGameParticles;
begin
